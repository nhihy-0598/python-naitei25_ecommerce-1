...
from .constants import STATUS_CHOICE, STATUS, RATING, RETURN_STATUS_CHOICES
...
class CartOrder(models.Model):
    ...
    coupons = models.ManyToManyField("core.Coupon", blank=True, related_name='cart_orders_many')
    coupon = models.ForeignKey(Coupon, on_delete=models.SET_NULL, null=True, blank=True, related_name='cart_orders_single')
